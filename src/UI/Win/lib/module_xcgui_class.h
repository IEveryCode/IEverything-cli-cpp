...
//@返回 如果成功返回TRUE,否则返回FALSE
//@别名  置项模板从内存()
	BOOL SetItemTemplateXMLFromMem(void* data, int length){return XList_SetItemTemplateXMLFromMem(m_hEle, data, length);}
//@备注 从RC资源ZIP加载
//@参数 id RC资源ID
//@参数 pFileName 项模板文件名
//@参数 pPassword zip密码
...
//@返回 如果成功返回TRUE,否则返回FALSE
//@别名  置项模板从内存()
	BOOL SetItemTemplateXMLFromMem(void* data, int length){return XListView_SetItemTemplateXMLFromMem(m_hEle, data, length);}
//@参数 id RC资源ID
//@参数 pFileName 文件名
//@参数 pPassword zip密码
//@参数 hModule 模块句柄
...
//@返回 如果成功返回TRUE,否则返回FALSE
//@别名  置项模板从内存()
	BOOL SetItemTemplateXMLFromMem(void* data, int length){return XTree_SetItemTemplateXMLFromMem(m_hEle, data, length);}
//@参数 id RC资源ID
//@参数 pFileName 文件名
//@参数 pPassword zip密码
//@参数 hModule 模块句柄
...
//@返回 如果成功返回TRUE,否则返回FALSE
//@别名  置项模板从内存()
	BOOL SetItemTemplateXMLFromMem(void* data, int length){return XComboBox_SetItemTemplateXMLFromMem(m_hEle, data, length);}
//@参数 id RC资源ID
//@参数 pFileName 文件名
//@参数 pPassword zip密码
//@参数 hModule 模块句柄
...
//@返回 返回炫彩字体句柄.
//@别名  创建从内存()
	HFONTX CreateFromMem(void* data, UINT length, int fontSize=12, int style=fontStyle_regular){m_hFont = XFont_CreateFromMem(data, length, fontSize, style);return m_hFont;}
//@参数 id 资源ID
...
//@返回 返回炫彩字体句柄
//@别名  创建从内存ZIP()
	HFONTX CreateFromZipMem(void* data, int length, const wchar_t* pFileName, const wchar_t* pPassword, int fontSize, int style){m_hFont = XFont_CreateFromZipMem(data, length, pFileName, pPassword, fontSize, style);return m_hFont;}
//@备注 是否自动销毁.  
//@参数 bEnable 是否启用.
//@别名  启用自动销毁()
