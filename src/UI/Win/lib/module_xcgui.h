...
//@返回 成功返回TRUE否则返回FALSE.
//@别名 列表_置选择项()
XC_API BOOL WINAPI XList_SetSelectItem(HELE hEle, int iRow);
//@备注 获取选择项.  
//@参数 hEle 元素句柄.
//@返回 行索引.
//@别名 列表_取选择项()
...
//@返回 成功返回TRUE,否则返回FALSE
//@别名 列表_添加选择项()
XC_API BOOL WINAPI XList_AddSelectItem(HELE hEle, int iRow);
//@备注 选择全部行.  
//@参数 hEle 元素句柄.
//@别名 列表_置选择全部()
...
//@参数 iRow 行索引.
//@别名 列表_显示指定项()
XC_API void WINAPI XList_VisibleItem(HELE hEle, int iRow);
//@备注 取消选择指定项(这里的项可以理解为行).  
//@参数 hEle 元素句柄.
//@参数 iRow 行索引.
//@返回 成功返回TRUE否则返回FALSE.
//@别名 列表_取消选择项()
XC_API BOOL WINAPI XList_CancelSelectItem(HELE hEle, int iRow);
...
//@参数 pSelHeight 选中时高度.
//@别名 列表_取项默认高度()
XC_API void WINAPI XList_GetItemHeightDefault(HELE hEle, int* pHeight, int* pSelHeight);
//@备注 设置项高度.  
//@参数 hEle 元素句柄.
//@参数 iRow 行索引
//@参数 nHeight 高度.
//@参数 nSelHeight 选中时高度.
//@别名 列表_置项高度()
XC_API void WINAPI XList_SetItemHeight(HELE hEle, int iRow, int nHeight, int nSelHeight);
//@备注 获取项高度.  
//@参数 hEle 元素句柄.
//@参数 iRow 行索引
//@参数 pHeight 高度.
//@参数 pSelHeight 选中时高度.
//@别名 列表_取项高度()
XC_API void WINAPI XList_GetItemHeight(HELE hEle, int iRow, int* pHeight, int* pSelHeight);
//@备注 设置行间距.  
//@参数 hEle 元素句柄.
//@参数 nSpace 行间距大小.
//@别名 列表_置行间距()
...
//@参数 iRow 行索引.
//@别名 列表_刷新指定项()
XC_API void WINAPI XList_RefreshItem(HELE hEle, int iRow);
//@返回 hEle  元素句柄
//@别名 列表_刷新项数据列表头()
...
//@参数 pValue 
//@别名 列表_插入项文本()
XC_API int WINAPI XList_InsertItemText(HELE hEle, int iRow, const wchar_t* pValue);
//@参数 hEle 
//@参数 iRow 
//@参数 pName 
//@参数 pValue 
//@别名 列表_插入项文本扩展()
XC_API int WINAPI XList_InsertItemTextEx(HELE hEle, int iRow, const wchar_t* pName, const wchar_t* pValue);
//@参数 hEle 
//@参数 iRow 
//@参数 hImage 
//@别名 列表_插入项图片()
XC_API int WINAPI XList_InsertItemImage(HELE hEle, int iRow, HIMAGE hImage);
//@参数 hEle 
//@参数 iRow 
//@参数 pName 
//@参数 hImage 
//@别名 列表_插入项图片扩展()
XC_API int WINAPI XList_InsertItemImageEx(HELE hEle, int iRow, const wchar_t* pName, HIMAGE hImage);
//@参数 hEle 
//@参数 iRow 行索引
...
//@返回 成功返回TRUE,否则返回FALSE
//@别名 列表_删除项()
XC_API BOOL WINAPI XList_DeleteItem(HELE hEle, int iRow);
//@参数 hEle 
//@参数 iRow 
//@参数 nCount 
//@返回 成功返回TRUE,否则返回FALSE
//@别名 列表_删除项扩展()
XC_API BOOL WINAPI XList_DeleteItemEx(HELE hEle, int iRow, int nCount);
//@参数 hEle 
//@别名 列表_删除项全部()
...
//@返回 返回插入位置索引.
//@别名 工具条_插入分割栏()
XC_API int WINAPI XToolBar_InsertSeparator(HELE hEle, int index=-1, COLORREF color=COLORREF_MAKE(128,128,128,255));
//@备注 启用下拉菜单,显示隐藏的项.  
//@参数 hEle 元素句柄.
//@参数 bEnable 是否启用.
//@别名 工具条_启用下拉菜单()
...
//@返回 成功返回TRUE否则返回FALSE.
//@别名 数据适配器表_取项整数值()
XC_API BOOL WINAPI XAdTable_GetItemInt(HXCGUI hAdapter, int iItem, int iColumn, int* pOutValue);
//@备注 获取项值.  
//@参数 hAdapter 数据适配器句柄.
//@参数 iItem 项索引.
//@参数 pName 字段称.
...
//@返回 成功返回TRUE否则返回FALSE.
//@别名 数据适配器表_取项整数值扩展()
XC_API BOOL WINAPI XAdTable_GetItemIntEx(HXCGUI hAdapter, int iItem, const wchar_t* pName, int* pOutValue);
//@备注 获取项值.  
//@参数 hAdapter 数据适配器句柄.
//@参数 iItem 项索引.
//@参数 iColumn 列索引.
...
//@返回 成功返回TRUE否则返回FALSE.
//@别名 数据适配器表_取项浮点值()
XC_API BOOL WINAPI XAdTable_GetItemFloat(HXCGUI hAdapter, int iItem, int iColumn, float* pOutValue);
//@备注 获取项值.  
//@参数 hAdapter 数据适配器句柄.
//@参数 iItem 项索引.
//@参数 pName 字段称.
...
//@返回 成功返回TRUE否则返回FALSE.
//@别名 数据适配器表_取项浮点值扩展()
XC_API BOOL WINAPI XAdTable_GetItemFloatEx(HXCGUI hAdapter, int iItem, const wchar_t* pName, float* pOutValue);
//@分组}
//@分组{  数据适配器MAP
...
//@参数 x 旋转中心点X
//@参数 y 旋转中心点Y
//@参数 bOffset TRUE:旋转中心点相对于自身中心偏移, FALSE:使用绝对坐标
//@别名 SVG_置旋转()
...
//@别名 SVG_取旋转()
XC_API void WINAPI XSvg_GetRotate(HSVG hSvg, float* pAngle, float* pX, float* pY, BOOL* pbOffset);
//@备注 显示或隐藏
//@参数 hSvg SVG句柄
//@参数 bShow 是否显示
//@别名 SVG_显示()
